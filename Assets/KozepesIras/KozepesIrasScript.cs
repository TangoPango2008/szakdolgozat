...
public class KozepesIrasScript : MonoBehaviour
{
    ...
    private const string BestTimesFile = "Assets/best_times_medium_write.txt";
    ...
    void SpawnNextObject()
    {
        ...
        Sprite sprite = Resources.Load<Sprite>($"OlvasasKozepesTargyak/{objectName}");
    ...
    void LoadBestTimes()
    {
        string persistentFilePath = Path.Combine(Application.persistentDataPath, "best_times_medium_write.txt");
        ...
        else
        {
            ...
            TextAsset textAsset = Resources.Load<TextAsset>("best_times_medium_write");
            if (textAsset != null)
            {
