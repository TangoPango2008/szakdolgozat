...
public class NehezIrasScript : MonoBehaviour
{
    ...
    private const string BestTimesFile = "Assets/best_times_hard_write.txt";
    ...
    void SpawnNextObject()
    {
        ...
        Sprite sprite = Resources.Load<Sprite>($"OlvasasNehezTargyak/{objectName}");
    ...
    void LoadBestTimes()
    {
        string persistentFilePath = Path.Combine(Application.persistentDataPath, "best_times_hard_write.txt");
        ...
        else
        {
            ...
            TextAsset textAsset = Resources.Load<TextAsset>("best_times_hard_write");
            if (textAsset != null)
            {
